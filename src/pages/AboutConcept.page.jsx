...
const tierData = {
    tier0:{
        svg:Blank,
        title:<div className="md:absolute top-[10em] right-20 w-1/2 my-auto">Hover over the graphic to find out more about the tiers. Then click on any tier to learn more about that tier!</div>,
        content:<> </>
    },
    tier1:{
        svg:Tier1,
