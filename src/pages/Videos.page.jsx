    ...
    return (
        <Section className="text-white" id="text-section">
            ...
            <div className="md:flex justify-between my-2" >
                <VideoAdSm className="md:w-[48%] opacity-0" href="https://youtu.be/NmiwAV9i5cY" embed="https://youtube.com/embed/NmiwAV9i5cY" id="video">
                    What do we mean by "Sympathy"?
                </VideoAdSm>
                <VideoAdSm className="md:w-[48%] mt-4 md:mt-0 opacity-0" href="https://youtu.be/q2bykgueC1I" embed="https://youtube.com/embed/q2bykgueC1I" id="video">
